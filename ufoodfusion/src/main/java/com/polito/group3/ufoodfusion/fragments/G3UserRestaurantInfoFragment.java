...
public class G3UserRestaurantInfoFragment extends android.support.v4.app.Fragment {
    ...
    private void initData() {
        ...
        getActivity().findViewById(R.id.infobutton).setBackgroundColor(ContextCompat.getColor(mCtx, R.color.secondary_text));
    ...
    public void onDestroyView() {
        ...
        getActivity().findViewById(R.id.infobutton).setBackgroundColor(ContextCompat.getColor(mCtx, R.color.light_grey));
        TextView tw = (TextView) getActivity().findViewById(R.id.infotextview);

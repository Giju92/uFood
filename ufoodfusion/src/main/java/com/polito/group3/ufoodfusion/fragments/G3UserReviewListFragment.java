...
import com.polito.group3.ufoodfusion.adapters.G3UserReviewAdapter;
...
//                mRestaurant = ((G3UserRestaurantActivity) getActivity()).getmRestaurantObj();
    ...
    public void onDestroyView() {
        ...
        getActivity().findViewById(R.id.reviewsbutton).setBackgroundColor(ContextCompat.getColor(mCtx, R.color.light_grey));
        TextView tw = (TextView) getActivity().findViewById(R.id.reviewtextview);

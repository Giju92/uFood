...
public class G3StatisticForm extends G3BaseActivity {
    ...
    private boolean monthByWeek = false;
...
//    private TextView aggbytext;
    private LinearLayout radioGroup;
    private RadioButton radiobyweek;
    private RadioButton radiobyday;
    ...
    private void monthByWeek(Date d) {
//        //set title
//        date.setText(type);
//        //filter order
//        filterOrder = filterlastMonth(d);
...
//        yAxis.setDrawGridLines(false);
        ...
        if (daily) {
//            aggbytext.setVisibility(View.GONE);
            radioGroup.setVisibility(View.GONE);

            //avoid to print all hours
            int i, start = 0;
            ...
            dataset.setColors(new int[]{ColorTemplate.VORDIPLOM_COLORS[2], ColorTemplate.VORDIPLOM_COLORS[1]});
...
//            aggbytext.setVisibility(View.GONE);
        ...
        if (month) {
//            aggbytext.setVisibility(View.VISIBLE);
        ...
        if (monthByWeek) {
            ...
            ArrayList<BarEntry> entries = new ArrayList<>();
            ArrayList<String> labels = new ArrayList<String>();
            labels.add(getResources().getString(R.string.mon));
            labels.add(getResources().getString(R.string.tue));
            labels.add(getResources().getString(R.string.wed));
            labels.add(getResources().getString(R.string.thu));
            labels.add(getResources().getString(R.string.fri));
            labels.add(getResources().getString(R.string.sat));
            labels.add(getResources().getString(R.string.sun));
...
//        aggbytext = (TextView) findViewById(R.id.aggregatebytext);
        radioGroup = (LinearLayout) findViewById(R.id.radiogroup);
        radiobyday = (RadioButton) findViewById(R.id.dayofmonth);
        radiobyweek = (RadioButton) findViewById(R.id.dayofweek);
    }
    ...
    void setListner() {
        ...
        if (done == 0) {
            ...
            radiobyday.setOnClickListener(radioclick);
            radiobyweek.setOnClickListener(radioclick);
        }
            ...
            switch(v.getId()) {
                case R.id.dayofweek:
                    if (checked) {
                        monthByWeek = true;
                        month = false;
                        monthByWeek(mDay = new Date());
                    }
                    break;
                case R.id.dayofmonth:
                    if (checked) {
                        monthByWeek = false;
                        month = true;
                        month(mDay = new Date());

...
public class G3MenuRestourantCategoryAdapter extends RecyclerView.Adapter<G3MenuRestourantCategoryAdapter.ViewHolder> {
    ...
    public G3MenuRestourantCategoryAdapter (ArrayList<G3MenuItem> dataSet){
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(temp.getTypeofItem() == 0){
            BitmapUtils.loadImage(R.drawable.drink_red,holder.mItemImage);
        }
        ...
        holder.mPriceItem.setText(String.format( "%.2f",temp.getPrice()) +" "+ G3Application.getAppContext().getString(R.string.euro_symbol));

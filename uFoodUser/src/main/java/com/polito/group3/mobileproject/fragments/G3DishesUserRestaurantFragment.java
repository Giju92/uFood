...
import com.polito.group3.mobileproject.adapters.G3DishMenuUserAdapter;
...
//    }
    ...
    private void initData() {
        ...
        getActivity().findViewById(R.id.menubutton).setBackgroundColor(ContextCompat.getColor(mCtx, com.example.ufoodlibrary.R.color.secondary_text));
    ...
    public void onDestroyView() {
        super.onDestroyView();
        getActivity().findViewById(R.id.menubutton).setBackgroundColor(ContextCompat.getColor(mCtx, com.example.ufoodlibrary.R.color.light_grey));
        TextView tw = (TextView) getActivity().findViewById(R.id.menutextview);
